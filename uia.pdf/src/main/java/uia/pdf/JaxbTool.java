...
public class JaxbTool<T> {
    ...
    public JaxbTool(Class<T> cls, String rootElement, String namespace, String packageName) throws JAXBException {
        this(cls, rootElement, namespace, packageName, null);
    }

    public JaxbTool(Class<T> cls, String rootElement, String namespace, String packageName, Schema schema) throws JAXBException {
        this.cls = cls;
    ...
    public class XMLNamespaceFilter extends XMLFilterImpl {
        ...
        public void startElement(String uri, String localName, String qName, org.xml.sax.Attributes attributes) throws SAXException {
            super.startElement(JaxbTool.this.namespace, localName, qName, attributes);
        }
    }
}
