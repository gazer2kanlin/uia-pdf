 ...
 *
 */
public class HeaderDescriptionView extends DescriptionView implements AbstractGridView {
    ...
    public HeaderDescriptionView(PDFMaker pdf, Paper paper, GridModel model, int height) {
        this.pdf = pdf;
        this.paper = paper;
        this.model = model;
        this.height = height;
